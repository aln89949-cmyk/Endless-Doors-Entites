...
local SelfModules = {
    DefaultConfig = loadstring(game:HttpGet("https://raw.githubusercontent.com/aln89949-cmyk/Endless-Doors-Entites/refs/heads/main/def.lua"))(),
    Functions = loadstring(game:HttpGet("https://raw.githubusercontent.com/aln89949-cmyk/Endless-Doors-Entites/refs/heads/main/Functions.lua"))(),
}
local ModuleScripts = {
